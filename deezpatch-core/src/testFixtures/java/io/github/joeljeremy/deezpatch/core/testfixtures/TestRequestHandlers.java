...
public class TestRequestHandlers {
  ...
  public static NoArgRequestHandler noArgRequestHandler() {
    return new NoArgRequestHandler();
  }

  public static InvalidArgRequestHandler invalidArgRequestHandler() {
    return new InvalidArgRequestHandler();
  }
  ...
  public static class NoArgRequestHandler {
    private NoArgRequestHandler() {}
  ...
  public static class InvalidArgRequestHandler {
    private InvalidArgRequestHandler() {}

    @RequestHandler
    public void invalid(String notARequest) {
      // Invalid. Parameter does not implement Request<T>.
    }
  }
