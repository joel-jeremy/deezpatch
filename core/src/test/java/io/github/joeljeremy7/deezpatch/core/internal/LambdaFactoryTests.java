...
public class LambdaFactoryTests {
    ...
    class CreateLambdaFunctionMethod {
        ...
        void test1() throws Throwable {
            Method handlerMethod = TestRequestHandler.class.getMethod(
                "handle", 
                TestRequest.class
            );
        ...
        void test3() throws Throwable {
            ...
            Method handlerMethod = handler.getClass().getMethod(
                "handle", 
                TestRequest.class
            );
            RequestHandlerMethod lambda = LambdaFactory.createLambdaFunction(
                handlerMethod, 
