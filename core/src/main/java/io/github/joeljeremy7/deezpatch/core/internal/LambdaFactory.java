...
public class LambdaFactory {
    ...
    public static <T> T createLambdaFunction(
        ...
        try {
            ...
            MethodHandle requestHandlerMethodHandle = lookup
                .in(requestHandlerClass)
            ...
            MethodType samMethodType = MethodType.methodType(
                samMethod.getReturnType(),
                samMethod.getParameterTypes()
            );
            ...
            throw new DeezpatchException(
                "Failed to build lambda function (" + functionalInterface.getName() +
                ") targeting method " + targetMethod.getName() + ".",
                ex
            );
        }
    }
