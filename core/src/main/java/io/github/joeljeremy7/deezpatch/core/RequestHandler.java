...
/**
 * Methods annotated with this annotation are registered as {@link Request} 
 * handlers.
 * 
 * @implSpec The annotated methods must accept a single method parameter which 
 * is the {@link Request} object. The method's return type must match the request's 
 * result type (primitives and wrapper types (including {@code Void}/{@code void}) 
 * are intercheangable).
 * 
