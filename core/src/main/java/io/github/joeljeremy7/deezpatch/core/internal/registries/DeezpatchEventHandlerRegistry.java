...
import io.github.joeljeremy7.deezpatch.core.EventHandlerRegistry;
...
public class DeezpatchEventHandlerRegistry 
    ...
    /** {@inheritDoc} */
    @Override
    public <T> List<RegisteredEventHandler<T>> getEventHandlersFor(
            Class<T> eventType
    ) {
        ...
        return new RegisteredEventHandler<Object>() {
            ...
            public void invoke(Object event) {
                eventHandlerMethodLambda.invoke(
                    instanceProvider.getInstance(eventHandlerClass), 
                    event
                );
            }
