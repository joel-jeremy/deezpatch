...
//                     @Override
//                     protected @Nullable K extract(WeakKey<K> u) {
//                         return u.get();
//                     }
//                 };
//             }
...
//                     @Override
//                     protected @Nullable Entry<K, V> extract(Entry<WeakKey<K>, V> u) {
//                         K key = u.getKey().get();
//                         if (key == null) {
//                             return null;
//                         } else {
...
//         public WeakKey(K referent, @Nullable ReferenceQueue<? super K> referenceQueue) {
...
//         protected @Nullable T strongNext;
...
//         protected abstract @Nullable T extract(U u);
//     }
// }
