...
/**
 * A {@link EventHandlerInvocationStrategy} implementation which invokes
 * the event handlers asynchronously.
 */
public class AsyncEventHandlerInvocationStrategy
        implements EventHandlerInvocationStrategy {
     ...
     * @param exceptionHandler The exception handler to handle event handler 
     * exceptions.
     */
